...
public class US10StepDefs extends BasePage {
    ...
    public void user_clicks_on_the_calendar_events_button() {
        ...
        //wait.until(ExpectedConditions.visibilityOf(createCalendarEventPage2.calendarEvent));
    ...
    @When("user  enter a {string}  in the Description field")
    public void user_enter_a_in_the_description_field(String message) {
...
/*
    @When("user  enter a message  in the Description field")
    public void user_enter_a_message_in_the_description_field() {
